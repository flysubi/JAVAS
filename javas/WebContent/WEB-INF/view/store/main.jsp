...
<div class="w3-row" style="padding-top: 10px;">
	<div class="w3-col m2 w3-center">
		<img src="/style/캘린더.png"></img>
		<p style="padding-top: 10px;">
			캘린더<br />200P
		</p>
	</div>
	<div class="w3-col m2 w3-center">
		<img src="/style/건강.png"></img>
		<p style="padding-top: 10px;">
			건강<br />200P
		</p>
	</div>
	<div class="w3-col m2 w3-center">
		<img src="/style/자산관리.png"></img>
		<p style="padding-top: 10px;">
			자산관리<br />200P
		</p>
	</div>
				...
				<div class="w3-col s4 w3-center">
					<p>
						<select class="w3-select w3-border" name="item" id="item">
							<option disabled selected>구매할 품목</option>
							...
							<option value="asset"
								${"asset" eq param.category ? 'selected' : ''}>자산관리</option>
							<option value="voice"
