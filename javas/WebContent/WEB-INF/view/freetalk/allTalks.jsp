		...
		<div class="col-xs-3 col-md-3">
				<select style="width: 223px;" class="w3-select w3-border"
					...
					<option value="" ${"" eq param.category ? 'selected' : ''}>전체
						카테고리 선택</option>
					<option value="교통" ${"교통" eq param.category ? 'selected' : ''}>교통</option>
					<option value=PC관리 ${"PC관리" eq param.category ? 'selected' : ''}>PC관리</option>
					<option value="인터넷" ${"인터넷" eq param.category ? 'selected' : ''}>인터넷</option>
				</select>
		</div>
