...
<body style="position: relative;">
			...
			<li>
				...
				<div
					...
					<button id="wbt" data-toggle="modal" data-target="#myModal"
						...
						<span data-tooltip-text="날씨 바로가기"> <img alt="lain"
							src="/style/날씨예보.png" onmouseover="this.src='/style/날씨예보반전.png'"
				...
				<div
					...
					<button id=cal style="background-color: transparent; border: none;">
						<span data-tooltip-text="캘랜더 바로가기"> <img alt="callender"
							src="/style/캘랜더.png" onmouseover="this.src='/style/캘랜더반전.png'"
				...
				<div
					...
					<a href="/function/map.jv">
						<span data-tooltip-text="길찾기 바로가기"> <img alt="callender"
	...
	<div style="position: relative;">
		<img alt="javas" src="/style/javas2.png"> <img alt="good"
			src="/style/좋은점.png"> <img alt="join" src="/style/가입문.png">

		<div style="position: absolute; left: 550px; top: 855px;">
			<a href="/user/join.jv"> <img alt="join2" src="/style/회원가입하러.png">
			</a>
		</div>
		<div style="position: absolute; left: 1280px; top: 855px">
			<a href="/menuer.jv"> <img alt="login2" src="/style/설정하러.png">
			</a>
		</div>
	</div>
	...
	<div class="modal fade" id="myModal" role="dialog">
		<div class="modal-dialog modal-fullsize">
			<div class="modal-content modal-fullsize">
				...
				<div class="modal-footer"
					style="background-color: #D2E4F1; padding-top: 9px; padding-bottom: 12px">
					<img src="/style/javasicon.png" style="width: 62px; height: 16px">
				</div>
			</div>
		</div>
